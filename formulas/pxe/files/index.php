...
$bootfile = str_replace("http://pxe2/preseed/host-type.preseed", "http://pxe2/preseed/".$type[0].".preseed", $bootfile);
...
$bootfile = str_replace("http://pxe2/kickstart/host-type.kickstart", "http://pxe2/kickstart/".$type[0].".kickstart", $bootfile);
$bootfile = str_replace("undefined-hostname", "$host_data[0]", $bootfile);
