...
install_mariadb:
  k8s_helm.helm_release_present:
    ...
    - set_values:
      ...
      - endpoints.oslo_db.auth.sst.password={{ pillar['osh']['mariadb_sst'] }}
      - endpoints.oslo_db.auth.audit.username=audit
      - endpoints.oslo_db.auth.audit.password={{ pillar['osh']['mariadb_audit'] }}
      - endpoints.oslo_db.auth.exporter.username=exporter
      - endpoints.oslo_db.auth.exporter.password={{ pillar['osh']['mariadb_exporter'] }}
