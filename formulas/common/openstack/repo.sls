...
uca:
  pkgrepo.managed:
    - humanname: Ubuntu Cloud Archive - Caracal
    - name: deb http://ubuntu-cloud.archive.canonical.com/ubuntu jammy-updates/caracal main
    - file: /etc/apt/sources.list.d/cloudarchive-caracal.list
    - keyid: EC4926EA
