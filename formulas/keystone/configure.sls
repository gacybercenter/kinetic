...
/etc/keystone/keystone.conf:
  file.managed:
    ...
    - template: jinja
    - defaults:
        sql_connection_string: 'connection = mysql+pymysql://keystone:{{ pillar['keystone']['keystone_mysql_password'] }}@{{ salt['mine.get']('type:mysql', 'network.ip_addrs', tgt_type='grain')[mysql*] }}/keystone'
