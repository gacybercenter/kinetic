...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        <div id="kc-form">
          <#assign loginNoticeText = msg("loginNotice")>
          <#if loginNoticeText?has_content && loginNoticeText != "loginNotice">
          <div id="kc-login-notice" class="kc-login-notice" role="note">
            ${kcSanitize(loginNoticeText)}
          </div>
          </#if>
